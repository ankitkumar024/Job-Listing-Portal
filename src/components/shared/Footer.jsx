...
const Footer = () => {
    return (
        <footer className="px-[10%] border-t border-[#dfd6d65b] py-4 mt-4">
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    <div className="mb-4 md:mb-0">
                    <h1 className='heading_color text-[18px]'>Career<span className='text-[#4a90e2]'>Hunt</span></h1>
                        <p className="text-sm text-[#d0cdcd]">© 2024 Your Company. All rights reserved.</p>
                    </div>

                    <div className="flex space-x-4 mt-4 md:mt-0">
                        <a href="https://facebook.com" className="text_color" aria-label="Facebook">
                        ...
                        <a href="https://twitter.com" className="text_color" aria-label="Twitter">
                        ...
                        <a href="https://linkedin.com" className="text_color" aria-label="LinkedIn">
